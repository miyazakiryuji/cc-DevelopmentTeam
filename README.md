...
| 既存コードをリファクタしたい         | `/cc-development-team:refactor <対象>` | 振る舞いを変えず内部を改善。既存テストの Before/After を厳守 |
...
| セキュリティ点検をしたい             | `/cc-development-team:security-review [名前]` | 認証・決済・個人情報を扱った後や、リリース前に。OWASP / 秘密情報 / 認可漏れを集中点検 |
