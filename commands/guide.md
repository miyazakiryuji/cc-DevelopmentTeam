...
```
【オススメ: /cc-development-team:architect】
...
▶ このあとの流れ:
  develop → (test) → (security-review) → status → release-check

▶ develop モードを抜けたい時は「終了」「終わり」「もう大丈夫」などと伝えてくださいね!
```
...
| テストを書く / 実行する | /cc-development-team:test |
...
2. 何を作るか整理 → /cc-development-team:architect
3. コード書く → /cc-development-team:develop
4. テストを書く / 実行 → /cc-development-team:test
5. 進捗確認 → /cc-development-team:status
6. セキュリティ点検 → /cc-development-team:security-review
7. リリース準備 → /cc-development-team:release-check
